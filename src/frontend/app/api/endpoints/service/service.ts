...
export const getPingQueryKey = () => {
  return [`/api/v1/Service/ping`] as const
}
...
export function usePing<TData = Awaited<ReturnType<typeof ping>>, TError = ErrorType<void>>(
  options: {
    query: Partial<UseQueryOptions<Awaited<ReturnType<typeof ping>>, TError, TData>> &
      Pick<
        DefinedInitialDataOptions<Awaited<ReturnType<typeof ping>>, TError, Awaited<ReturnType<typeof ping>>>,
        'initialData'
      >
  },
...
export function usePing<TData = Awaited<ReturnType<typeof ping>>, TError = ErrorType<void>>(
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof ping>>, TError, TData>> &
      Pick<
        UndefinedInitialDataOptions<Awaited<ReturnType<typeof ping>>, TError, Awaited<ReturnType<typeof ping>>>,
        'initialData'
      >
  },
  queryClient?: QueryClient,
...
export const getVersionQueryKey = () => {
  return [`/api/v1/Service/version`] as const
}
...
export function useVersion<TData = Awaited<ReturnType<typeof version>>, TError = ErrorType<void>>(
  options: {
    query: Partial<UseQueryOptions<Awaited<ReturnType<typeof version>>, TError, TData>> &
      Pick<
        DefinedInitialDataOptions<Awaited<ReturnType<typeof version>>, TError, Awaited<ReturnType<typeof version>>>,
        'initialData'
      >
  },
  queryClient?: QueryClient,
...
export function useVersion<TData = Awaited<ReturnType<typeof version>>, TError = ErrorType<void>>(
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof version>>, TError, TData>> &
      Pick<
        UndefinedInitialDataOptions<Awaited<ReturnType<typeof version>>, TError, Awaited<ReturnType<typeof version>>>,
        'initialData'
      >
  },
  queryClient?: QueryClient,
